...
import DataBrowserGridControls from '@/features/database/components/DataBrowserGridControls';
import useDeleteColumnWithToastMutation from '@/features/database/hooks/useDeleteColumnMutation/useDeleteColumnWithToastMutation';
import useTableQuery from '@/features/database/hooks/useTableQuery';
import type { UpdateRecordVariables } from '@/features/database/hooks/useUpdateRecordMutation';
import useUpdateRecordWithToastMutation from '@/features/database/hooks/useUpdateRecordMutation/useUpdateRecordWithToastMutation';
import normalizeDefaultValue from '@/features/database/utils/normalizeDefaultValue';
import {
  POSTGRESQL_CHARACTER_TYPES,
  POSTGRESQL_DATE_TIME_TYPES,
  POSTGRESQL_JSON_TYPES,
  POSTGRESQL_NUMERIC_TYPES,
} from '@/features/database/utils/postgresqlConstants';
import { isSchemaLocked } from '@/features/database/utils/schemaHelpers';
...
const CreateColumnForm = dynamic(
  () => import('@/features/database/components/CreateColumnForm'),
  { ssr: false, loading: () => <FormActivityIndicator /> },
);

const EditColumnForm = dynamic(
  () => import('@/features/database/components/EditColumnForm'),
  { ssr: false, loading: () => <FormActivityIndicator /> },
);

const CreateRecordForm = dynamic(
  () => import('@/features/database/components/CreateRecordForm'),
  { ssr: false, loading: () => <FormActivityIndicator /> },
);
