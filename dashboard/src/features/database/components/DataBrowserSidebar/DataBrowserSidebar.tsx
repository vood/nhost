...
import useDatabaseQuery from '@/features/database/hooks/useDatabaseQuery';
import useDeleteTableWithToastMutation from '@/features/database/hooks/useDeleteTableMutation/useDeleteTableWithToastMutation';
...
const CreateTableForm = dynamic(
  () => import('@/features/database/components/CreateTableForm'),
  {
    ssr: false,
...
const EditTableForm = dynamic(
  () => import('@/features/database/components/EditTableForm'),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
  },
...
const EditPermissionsForm = dynamic(
  () => import('@/features/database/components/EditPermissionsForm'),
  {
    ssr: false,
    loading: () => <FormActivityIndicator />,
  },
