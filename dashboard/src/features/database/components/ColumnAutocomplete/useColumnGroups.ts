import type { FetchMetadataReturnType } from '@/features/database/hooks/useMetadataQuery';
import type { FetchTableReturnType } from '@/features/database/hooks/useTableQuery';
