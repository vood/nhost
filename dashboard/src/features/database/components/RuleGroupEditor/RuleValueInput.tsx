...
import type { ColumnAutocompleteProps } from '@/features/database/components/ColumnAutocomplete';
import ColumnAutocomplete from '@/features/database/components/ColumnAutocomplete';
