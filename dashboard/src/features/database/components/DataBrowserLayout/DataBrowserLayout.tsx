...
import type { DataBrowserSidebarProps } from '@/features/database/components/DataBrowserSidebar';
import DataBrowserSidebar from '@/features/database/components/DataBrowserSidebar';
