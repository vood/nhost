import type {
  BaseTableFormProps,
  BaseTableFormValues,
} from '@/features/database/components/BaseTableForm';
import BaseTableForm, {
  baseTableValidationSchema,
} from '@/features/database/components/BaseTableForm';
import useTableQuery from '@/features/database/hooks/useTableQuery';
import useTrackForeignKeyRelationsMutation from '@/features/database/hooks/useTrackForeignKeyRelationsMutation';
import useUpdateTableMutation from '@/features/database/hooks/useUpdateTableMutation';
import normalizeDatabaseColumn from '@/features/database/utils/normalizeDatabaseColumn';
import type {
  DatabaseTable,
