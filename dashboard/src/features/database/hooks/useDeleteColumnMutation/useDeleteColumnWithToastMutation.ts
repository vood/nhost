import type { UseDeleteColumnMutationOptions } from '@/features/database/hooks/useDeleteColumnMutation';
import useDeleteColumnMutation from '@/features/database/hooks/useDeleteColumnMutation';
