import type { UseDeleteTableMutationOptions } from '@/features/database/hooks/useDeleteTableMutation';
import useDeleteTableMutation from '@/features/database/hooks/useDeleteTableMutation';
