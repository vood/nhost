import { prepareCreateColumnQuery } from '@/features/database/hooks/useCreateColumnMutation';
import { prepareUpdateColumnQuery } from '@/features/database/hooks/useUpdateColumnMutation';
import { getPreparedHasuraQuery } from '@/features/database/utils/hasuraQueryHelpers';
import prepareCreateForeignKeyRelationQuery from '@/features/database/utils/prepareCreateForeignKeyRelationQuery';
import prepareUpdateForeignKeyConstraintQuery from '@/features/database/utils/prepareUpdateForeignKeyRelationQuery/prepareUpdateForeignKeyRelationQuery';
import type {
  DatabaseColumn,
  DatabaseTable,
  ForeignKeyRelation,
